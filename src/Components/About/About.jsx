      ...
      <div className={style.Container}>
        <div className={style.row}>
          <div className={style.content}>
            <h1>About Us</h1>
            <p>
              Fire Blocks is a developing & leading software development company
              known for its highly effective & innovative digital solutions that
              helps in evolving a brand, business or application. We provide you
              exceptional insight of your customers that helps you to expand
              your web & mobile application customer base. Our highly-qualified
              & skilled team makes sure to properly analyze & implement
              techniques that help you to generate revenue & build a strong
              community of customers with potential engagement. <br />
              <br />
